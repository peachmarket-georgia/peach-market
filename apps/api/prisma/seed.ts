...
async function main() {
  ...
  const user1 = await prisma.user.upsert({
    where: { email: 'test1@peachmarket.com' },
    update: {},
    create: {
      email: 'test1@peachmarket.com',
      password: '$2b$10$dummyhashedpassword1234567890abc', // 실제 로그인 불가, 시드 전용
      nickname: '복숭아맘',
      location: 'Duluth, GA',
      mannerScore: 4.5,
    },
  ...
  const user2 = await prisma.user.upsert({
    where: { email: 'test2@peachmarket.com' },
    update: {},
    create: {
  ...
  const products = await Promise.all([
    prisma.product.create({
      data: {
        ...
        description:
          '작년에 구매한 아이패드 프로입니다. 스크래치 없이 깨끗하게 사용했습니다. 애플펜슬 2세대 포함.',
        price: 65000, // $650.00
        status: ProductStatus.SELLING,
        images: [
          'https://placehold.co/600x400?text=iPad+Pro+1',
          'https://placehold.co/600x400?text=iPad+Pro+2',
        ],
        location: 'Duluth, GA',
        viewCount: 42,
      },
    ...
    prisma.product.create({
      data: {
        ...
        title: '다이슨 V15 무선청소기',
        description:
          '6개월 사용. 흡입력 좋고 배터리 상태 양호합니다. 박스, 부속품 전부 있습니다.',
        price: 35000, // $350.00
        status: ProductStatus.SELLING,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          '게이밍 모니터 판매합니다. 240Hz, 1ms 응답속도. 데드픽셀 없습니다.',
        price: 28000, // $280.00
    ...
    prisma.product.create({
      data: {
        ...
        description:
          '한국 교과서 풀세트입니다. 깨끗하게 사용했고 연필 자국 조금 있습니다.',
        price: 5000, // $50.00
    ...
    prisma.product.create({
      data: {
        ...
        title: '코스트코 김치냉장고 (딤채)',
        description:
          '이사로 인해 급처합니다. 2년 사용, 상태 아주 좋습니다. 직접 픽업만 가능.',
        price: 40000, // $400.00
        status: ProductStatus.SELLING,
        images: [
