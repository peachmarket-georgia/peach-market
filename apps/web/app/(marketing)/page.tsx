      ...
      <section className="pt-28 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-xl mb-8">
            검증되지 않은 판매자, 추적 불가능한 대화 기록, 영어로만 검색되는
            마켓플레이스. 피치마켓은 조지아 한인을 위해 만들어졌습니다.
          </p>

          <div className="flex items-center gap-3">
            <Link href="/marketplace">
              <Button size="lg">매물 보기</Button>
            </Link>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-background p-6 rounded-lg border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                한인회, 교회, 학교 등 커뮤니티 연결을 통한 신원 확인. 거래
                후기와 평점으로 신뢰도를 쌓아갑니다.
              </p>
            </div>
            ...
            <div className="bg-background p-6 rounded-lg border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                모든 대화와 거래 내역이 안전하게 저장됩니다. 문제 발생 시 증거로
                활용할 수 있습니다.
              </p>
            </div>
            ...
            <div className="bg-background p-6 rounded-lg border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                한국어로 검색하고, 한인 판매자의 매물만 모아봅니다. 둘루스,
                스와니, 존스크릭 등 지역 기반 탐색.
              </p>
            </div>
            ...
            <div className="bg-background p-6 rounded-lg border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                사기 예방 가이드, 안전한 거래 장소 추천, 신고 및 차단 기능으로
                건전한 거래 환경을 만듭니다.
              </p>
            </div>
          </div>
