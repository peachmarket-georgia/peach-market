  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-4 py-6">
        ...
        {/* 차단 목록 */}
        <Link href="/mypage/blocked-users">
          <section className="bg-card rounded-2xl px-6 py-4 mb-6 shadow-sm flex items-center justify-between gap-4 cursor-pointer active:opacity-70">
            <div className="flex items-center gap-3">
              <IconBan className="w-5 h-5 text-destructive shrink-0" />
              <div>
                <p className="text-sm font-medium">차단한 사용자</p>
                <p className="text-xs text-muted-foreground">차단한 사용자를 관리합니다</p>
              </div>
            </div>
